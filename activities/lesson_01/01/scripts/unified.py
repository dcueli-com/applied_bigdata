...
# ----------------------------------------------------------------------------------------------------
timeInit  = time.time()
df_target = pd.read_csv('../dataset/ml-20m/movies.csv')
timeEnd   = time.time()

print(f"Time to load the dataset with Pandas: {timeEnd - timeInit:.4f} seconds")
print(f"Time to load the dataset with Pandas: {timeEnd - timeInit:.2f} seconds")
...
timeInit = time.time()
df_target = pl.read_csv('../dataset/ml-20m/movies.csv')
timeEnd = time.time()

print(f"Time to load the dataset with Polars: {timeEnd - timeInit:.4f} seconds")
print(f"Time to load the dataset with Polars: {timeEnd - timeInit:.2f} seconds")
